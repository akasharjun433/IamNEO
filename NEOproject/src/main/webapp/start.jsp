...
<%@ page import="com.neo.Controller.Fetch2Controller" %>
<jsp:useBean id="myServlet2" class="com.neo.Controller.Fetch2Controller" scope="request" />

<%@ page import="com.neo.Controller.Fetch3Controller" %>
<jsp:useBean id="myServlet3" class="com.neo.Controller.Fetch3Controller" scope="request" />

<%@ page import="com.neo.Controller.Fetch4Controller" %>
<jsp:useBean id="myServlet4" class="com.neo.Controller.Fetch4Controller" scope="request" />
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="start.jsp" class="site_title"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="37" style="margin-left:10px;"  fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            <div class="row gx-5">
              <div class="col">
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;border-left:6px solid rgb(137, 137, 137) ;">
                    <td style="color:  #000000;font-weight: 800;padding-top: 10px;">&nbsp;&nbsp;Open - 11</td>
                  </tr>
                </table>
              </div>
              <div class="col">
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;border-left:6px solid #F2B23E;">
                    <td style="color:   #000000;font-weight: 800;padding-top: 10px;">&nbsp;&nbsp;Contacted - 5</td>
                  </tr>
                </table>
              </div>
              <div class="col">
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;border-left:6px solid #F2B23E;">
                    <td style="color:   #000000;font-weight: 800;padding-top: 10px;">&nbsp;&nbsp;Written test - 10
              ...
              <div class="col">
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;border-left:6px solid #F2B23E;">
                    <td style="color:   #000000;font-weight: 800;padding-top: 10px;">&nbsp;&nbsp;Written Test completed - 3
              ...
              <div class="col">
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;border-left:6px solid #F2B23E;">
                    <td style="color:   #000000;font-weight: 800;padding-top: 10px;">&nbsp;&nbsp;Newton School - 0
                    </td>
                  </tr>
                </table>
              </div>
...
<%
    ...
    Map<List<String>,byte[]> lb1 = mySer1.fetch();
	
	 %>
	 <%
    // Accessing the servlet instance
    Fetch2Controller mySer2 = new Fetch2Controller();
    Map<List<String>,byte[]> lb2 = mySer2.fetch();
	
	 %>
	 <%
    // Accessing the servlet instance
    Fetch3Controller mySer3 = new Fetch3Controller();
    Map<List<String>,byte[]> lb3 = mySer3.fetch();
	
	 %>
	 <%
    // Accessing the servlet instance
    Fetch4Controller mySer4 = new Fetch4Controller();
    Map<List<String>,byte[]> lb4 = mySer4.fetch();
	 ...
	 %>
            <div class="row gx-5">
              ...
              <% for(Map.Entry<List<String>,byte[]> nm:lb.entrySet()){ 
                 ...
                 %>
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;border-left:6px solid green ;">
                  <form action="ProfileServlet" method="get">
                    <td style="color:  #6b9ae2;font-weight: 800;padding-top: 10px;">&nbsp;&nbsp;<button class="btn"  type="submit" style="color:black; text-decoration:none;" value="<%= nm.getKey().get(i++) %>" name="id" ><%= nm.getKey().get(i++) %> </button>
                   </form>
                    <br>
              ...
              <div class="col">
               <% for(Map.Entry<List<String>,byte[]> nm:lb2.entrySet()){ 
            	     int i=0;
                 %>
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;">
              ...
              <div class="col">
               <% for(Map.Entry<List<String>,byte[]> nm:lb3.entrySet()){ 
            	     int i=0;
                 %>
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;">
              ...
              <div class="col">
               <% for(Map.Entry<List<String>,byte[]> nm:lb4.entrySet()){ 
            	     int i=0;
                 %>
                <table style="width: 100%;">
                  <tr style="height: 60px;background-color: #fffefe;">
          ...
          <div class="modal-body">
            <form  action="addcandidate" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="recipient-name" name="ins" required>
              </div>
              <div class="form-group">
